...
function redirectUser(id) {
  switch (id) {
    case "1":
      ...
      window.location.href = 'esp_html/ESP_noPaperwork.html';
      break;
    case "2":
      // localStorage.setItem("tree", "treeData3.json");
      window.location.href = 'esp_html/ESP_familyVisaApp.html';
      break;
    case "3":
      // localStorage.setItem("tree", "treeData3.json");
      window.location.href = 'esp_html/ESP_familyBorder.html';
      break;
    case "4":
      // localStorage.setItem("tree", "treeData4.json");
      window.location.href = 'esp_html/ESP_reunification.html';
      break;
    case "5":
      // localStorage.setItem("tree", "treeData2.json");
      window.location.href = 'esp_html/ESP_familyVisaPet.html';
      break;
    case "6":
      // localStorage.setItem("tree", "treeData2.json");
      window.location.href = 'esp_html/ESP_familyVisaPet.html';
    ...
    case "8":
      // localStorage.setItem("tree", "treeData2.json");
      window.location.href = 'esp_html/ESP_detained.html';
      break;
    case "9":
      // localStorage.setItem("tree", "treeData2.json");
      window.location.href = 'esp_html/ESP_CRBA.html';
      break;
      case "10":
      window.location.href = 'esp_html/ESP_reunification.html';
      break;
      case "11":
      window.location.href = 'esp_html/ESP_CRBAv2.html';
      break;
      case "12":
        window.location.href = 'esp_html/ESP_migrantVisa.html';
        break;
    default:
      alert("something went wrong");
      break;
